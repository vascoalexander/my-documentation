...
public class Program
{
    public static void Main()
    {
        // Erstellen eines Dictionaries (Schlüssel: string, Wert: int)
        ...
        // Überprüfen, ob ein bestimmter Schlüssel existiert
        if (dictionary.ContainsKey("Bernd"))
        {
            Console.WriteLine("\nBernd ist im Dictionary vorhanden.");
        }

        // Aktualisieren eines Wertes über den Schlüssel
        dictionary["Clara"] = 31;
        ...
        // Löschen aller Einträge im Dictionary
        dictionary.Clear();
